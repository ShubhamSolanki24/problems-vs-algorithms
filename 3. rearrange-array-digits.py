...
#     """
#     first, second = '', ''
#     while len(input_list) > 0:  # O(n * (n -2)) --->  O(n^2)
#         max_idx = input_list.index(max(input_list))
#         first += str(input_list.pop(max_idx))
#         if len(input_list) > 0:
#             second_max_idx = input_list.index(max(input_list))
#             second += str(input_list.pop(second_max_idx))
#
